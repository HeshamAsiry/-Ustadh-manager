...
export default function DashboardPage(){
 ...
 return <AppShell><main className="dashboard-page">
   <section className="dashboard-hero">
    ...
    <div className="dashboard-quick"><Link className="outline-btn" href="/students?action=new"><Plus size={16}/> طالب جديد</Link><Link className="primary-btn" href="/calendar-riwaq?action=new"><CalendarDays size={16}/> إضافة موعد</Link></div>
   </section>
